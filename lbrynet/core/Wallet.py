...
class Wallet(object):
    ...
    @defer.inlineCallbacks
    def resolve(self, check_cache, page, start_position, *uris):
        result = {}
        needed = []
        for uri in uris:
            cached_claim = None
        ...
        batch_results = yield self._get_values_for_uris(page, start_position, *uris)
    ...
    def _get_values_for_uris(self, page, start_position, *uris):
        return defer.fail(NotImplementedError())
...
class LBRYumWallet(Wallet):
    ...
    def _get_values_for_uris(self, page, start_position, *uris):
        return self._run_cmd_as_defer_to_thread('getvaluesforuris', False, page, start_position,
                                                *uris)
